  ...
  <div class="q-pa-md">
    ...
    >
      <template v-slot:top-right>
        <q-input class="bg-white" borderless dense debounce="300" v-model="filter" placeholder="Search">
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            <q-td
              ...
              :props="props"
            >
            <router-link :to="{ name: 'postDetail', params: {id:props.row.id, name:props.row.title}}" style="color: inherit;text-decoration: none;">
              {{ col.value }}
            </router-link>
            </q-td>
            <q-td auto-width>

  ...
  <q-layout view="hHh LpR fFf">
    <q-header elevated :class="`text-white header`">
      <q-toolbar class="d-flex justify-between">
        ...
        <span class="mobile-hide gt-xs">Menu</span>

        <q-toolbar-title class="mobile-hide gt-xs">
          <q-avatar>
        ...
        <q-toggle
          ...
          @click="themeMode"
        />
        <span class="mobile-hide gt-xs">Profile</span>
        <q-btn dense flat round icon="menu" @click="toggleRightDrawer" />
      </q-toolbar>
    </q-header>

    <q-drawer show-if-above v-model="leftDrawerOpen" behavior="mobile" side="left" elevated>
      <!-- drawer content -->
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" behavior="mobile" side="right" elevated>
      <!-- drawer content -->
...
import { profile, profileTemp, userData } from 'src/components/dashboard/ts/profileComponent';
